...
/**
     ...
     * limitations under the License.
     */
class de{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const pe="@firebase/app",fe="0.10.18",_e=new Y("@firebase/app"),me="@firebase/app-compat",ge="@firebase/analytics-compat",ve="@firebase/analytics",ye="@firebase/app-check-compat",we="@firebase/app-check",be="@firebase/auth",Ie="@firebase/auth-compat",Ce="@firebase/database",Te="@firebase/data-connect",ke="@firebase/database-compat",Ee="@firebase/functions",Se="@firebase/functions-compat",Re="@firebase/installations",Ne="@firebase/installations-compat",Pe="@firebase/messaging",Ae="@firebase/messaging-compat",Oe="@firebase/performance",De="@firebase/performance-compat",Le="@firebase/remote-config",xe="@firebase/remote-config-compat",Me="@firebase/storage",Ue="@firebase/storage-compat",Fe="@firebase/firestore",qe="@firebase/vertexai",ze="@firebase/firestore-compat",je="firebase",We="[DEFAULT]",He={[pe]:"fire-core",[me]:"fire-core-compat",[ve]:"fire-analytics",[ge]:"fire-analytics-compat",[we]:"fire-app-check",[ye]:"fire-app-check-compat",[be]:"fire-auth",[Ie]:"fire-auth-compat",[Ce]:"fire-rtdb",[Te]:"fire-data-connect",[ke]:"fire-rtdb-compat",[Ee]:"fire-fn",[Se]:"fire-fn-compat",[Re]:"fire-iid",[Ne]:"fire-iid-compat",[Pe]:"fire-fcm",[Ae]:"fire-fcm-compat",[Oe]:"fire-perf",[De]:"fire-perf-compat",[Le]:"fire-rc",[xe]:"fire-rc-compat",[Me]:"fire-gcs",[Ue]:"fire-gcs-compat",[Fe]:"fire-fst",[ze]:"fire-fst-compat",[qe]:"fire-vertex","fire-js":"fire-js",[je]:"fire-js-all"},Be=new Map,Ve=new Map,$e=new Map;function Ke(e,t){try{e.container.addComponent(t)}catch(n){_e.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Ge(e){const t=e.name;if($e.has(t))return _e.debug(`There were multiple attempts to register component ${t}.`),!1;$e.set(t,e);for(const t of Be.values())Ke(t,e);for(const t of Ve.values())Ke(t,e);return!0}function Ye(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function Je(e){return void 0!==e.settings}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
nt("firebase","11.2.0","app"),"function"==typeof SuppressedError&&SuppressedError;const _t=ft,mt=new C("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),gt=new Y("@firebase/auth");function vt(e,...t){gt.logLevel<=B.ERROR&&gt.error(`Auth (${Ze}): ${e}`,...t)}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function xt(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function Mt(e,t,n,i,r={}){return Ut(e,r,(async()=>{let r={},s={};i&&("GET"===t?s=i:r={body:JSON.stringify(i)});const o=L(Object.assign({key:e.config.apiKey},s)).slice(1),a=await e._getAdditionalHeaders();a["Content-Type"]="application/json",e.languageCode&&(a["X-Firebase-Locale"]=e.languageCode);const l=Object.assign({method:t,headers:a},r);return"undefined"!=typeof navigator&&"Cloudflare-Workers"===navigator.userAgent||(l.referrerPolicy="no-referrer"),Ot.fetch()(Ft(e,e.config.apiHost,n,o),l)}))}async function Ut(e,t,n){e._canInitEmulator=!1;const i=Object.assign(Object.assign({},Dt),t);try{const t=new qt(e),r=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const s=await r.json();if("needConfirmation"in s)throw zt(e,"account-exists-with-different-credential",s);if(r.ok&&!("errorMessage"in s))return s;{const t=r.ok?s.errorMessage:s.error.message,[n,o]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw zt(e,"credential-already-in-use",s);if("EMAIL_EXISTS"===n)throw zt(e,"email-already-in-use",s);if("USER_DISABLED"===n)throw zt(e,"user-disabled",s);const a=i[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(o)throw bt(e,a,o);yt(e,a)}}catch(t){if(t instanceof I)throw t;yt(e,"network-request-failed",{message:String(t)})}}function Ft(e,t,n,i){const r=`${t}${n}?${i}`;return e.config.emulator?At(e.config,r):`${e.config.apiScheme}://${r}`}class qt{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(wt(this.auth,"network-request-failed"))),Lt.get())}))}}function zt(e,t,n){const i={appName:e.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const r=wt(e,t,i);return r.customData._tokenResponse=n,r}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Wt(e){if(e)try{const t=new Date(Number(e));if(!isNaN(t.getTime()))return t.toUTCString()}catch(e){}}function Ht(e){return 1e3*Number(e)}function Bt(e){const[t,n,i]=e.split(".");if(void 0===t||void 0===n||void 0===i)return vt("JWT malformed, contained fewer than 3 sections"),null;try{const e=c(n);return e?JSON.parse(e):(vt("Failed to decode base64 JWT payload"),null)}catch(e){return vt("Caught error parsing JWT payload as JSON",null==e?void 0:e.toString()),null}}function Vt(e){const t=Bt(e);return Tt(t,"internal-error"),Tt(void 0!==t.exp,"internal-error"),Tt(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Vn extends Wn{constructor(){super((()=>window.sessionStorage),"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Vn.type="SESSION";const $n=Vn;
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
return async function(e,t,n=!1){if(Je(e.app))return Promise.reject(It(e));const i="signIn",r=await zn(e,i,t),s=await Un._fromIdTokenResponse(e,i,r);return n||await e._updateCurrentUser(s.user),s}(e.auth,new li(e),e.bypassAuthState)}function hi(e){const{auth:t,user:n}=e;return Tt(n,t,"internal-error"),
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const Lr=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,xr="ac",Mr="websocket",Ur="long_polling";
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
class Br{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const e=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let t=0;t<e.length;++t)e[t]&&Nr((()=>{this.onMessage_(e[t])}));if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let Bs;class Vs{static get EMPTY_NODE(){return Bs||(Bs=new Vs(new Ss(Ns),null,Hs.Default))}constructor(e,t,i){this.children_=e,this.priorityNode_=t,this.indexMap_=i,this.lazyHash_=null,this.priorityNode_&&Os(this.priorityNode_),this.children_.isEmpty()&&n(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Bs}updatePriority(e){return this.children_.isEmpty()?this:new Vs(this.children_,e,this.indexMap_)}getImmediateChild(e){if(".priority"===e)return this.getPriority();{const t=this.children_.get(e);return null===t?Bs:t}}getChild(e){const t=is(e);return null===t?this:this.getImmediateChild(t).getChild(ss(e))}hasChild(e){return null!==this.children_.get(e)}updateImmediateChild(e,t){if(n(t,"We should always be passing snapshot nodes"),".priority"===e)return this.updatePriority(t);{const n=new ws(e,t);let i,r;t.isEmpty()?(i=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(n,this.children_)):(i=this.children_.insert(e,t),r=this.indexMap_.addToIndexes(n,this.children_));const s=i.isEmpty()?Bs:this.priorityNode_;return new Vs(i,s,r)}}updateChild(e,t){const i=is(e);if(null===i)return t;{n(".priority"!==is(e)||1===rs(e),".priority must be the last token in a path");const r=this.getImmediateChild(i).updateChild(ss(e),t);return this.updateImmediateChild(i,r)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let n=0,i=0,r=!0;if(this.forEachChild(Us,((s,o)=>{t[s]=o.val(e),n++,r&&Vs.INTEGER_REGEXP_.test(s)?i=Math.max(i,Number(s)):r=!1})),!e&&r&&i<2*n){const e=[];for(const n in t)e[n]=t[n];return e}return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(null===this.lazyHash_){let e="";this.getPriority().isEmpty()||(e+="priority:"+As(this.getPriority().val())+":"),this.forEachChild(Us,((t,n)=>{const i=n.hash();""!==i&&(e+=":"+t+":"+i)})),this.lazyHash_=""===e?"":lr(e)}return this.lazyHash_}getPredecessorChildName(e,t,n){const i=this.resolveIndex_(n);if(i){const n=i.getPredecessorKey(new ws(e,t));return n?n.name:null}return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.minKey();return e&&e.name}return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new ws(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.maxKey();return e&&e.name}return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new ws(t,this.children_.get(t)):null}forEachChild(e,t){const n=this.resolveIndex_(e);return n?n.inorderTraversal((e=>t(e.name,e.node))):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(e=>e));{const n=this.children_.getIteratorFrom(e.name,ws.Wrap);let i=n.peek();for(;null!=i&&t.compare(i,e)<0;)n.getNext(),i=n.peek();return n}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(e=>e));{const n=this.children_.getReverseIteratorFrom(e.name,ws.Wrap);let i=n.peek();for(;null!=i&&t.compare(i,e)>0;)n.getNext(),i=n.peek();return n}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===$s?-1:0}withIndex(e){if(e===Ts||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new Vs(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===Ts||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){const e=this.getIterator(Us),n=t.getIterator(Us);let i=e.getNext(),r=n.getNext();for(;i&&r;){if(i.name!==r.name||!i.node.equals(r.node))return!1;i=e.getNext(),r=n.getNext()}return null===i&&null===r}return!1}return!1}}resolveIndex_(e){return e===Ts?null:this.indexMap_.get(e.toString())}}Vs.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;const $s=new class extends Vs{constructor(){super(new Ss(Ns),Vs.EMPTY_NODE,Hs.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return Vs.EMPTY_NODE}isEmpty(){return!1}};Object.defineProperties(ws,{MIN:{value:new ws(vr,Vs.EMPTY_NODE)},MAX:{value:new ws(yr,$s)}}),Cs.__EMPTY_NODE=Vs.EMPTY_NODE,Ms.__childrenNodeConstructor=Vs,Ps=$s,function(e){xs=e}($s);function Ks(e,t=null){if(null===e)return Vs.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),n(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e){return new Ms(e,Ks(t))}if(e instanceof Array){let n=Vs.EMPTY_NODE;return kr(e,((t,i)=>{if(R(e,t)&&"."!==t.substring(0,1)){const e=Ks(i);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(Ks(t))}{const n=[];let i=!1;if(kr(e,((e,t)=>{if("."!==e.substring(0,1)){const r=Ks(t);r.isEmpty()||(i=i||!r.getPriority().isEmpty(),n.push(new ws(e,r)))}})),0===n.length)return Vs.EMPTY_NODE;const r=zs(n,Rs,(e=>e.name),Ns);if(i){const e=zs(n,Us.getCompare());return new Vs(r,Ks(t),new Hs({".priority":e},{".priority":Us}))}return new Vs(r,Ks(t),Hs.Default)}}!function(e){Ls=e}(Ks);
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
class Qs{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=Us}hasStart(){return this.startSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return n(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return n(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:vr}hasEnd(){return this.endSet_}getIndexEndValue(){return n(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return n(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:yr}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return n(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===Us}copy(){const e=new Qs;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function Xs(e){const t={};if(e.isDefault())return t;let i;if(e.index_===Us?i="$priority":e.index_===Ys?i="$value":e.index_===Ts?i="$key":(n(e.index_ instanceof Gs,"Unrecognized index type!"),i=e.index_.toString()),t.orderBy=E(i),e.startSet_){const n=e.startAfterSet_?"startAfter":"startAt";t[n]=E(e.indexStartValue_),e.startNameSet_&&(t[n]+=","+E(e.indexStartName_))}if(e.endSet_){const n=e.endBeforeSet_?"endBefore":"endAt";t[n]=E(e.indexEndValue_),e.endNameSet_&&(t[n]+=","+E(e.indexEndName_))}return e.limitSet_&&(e.isViewFromLeft()?t.limitToFirst=e.limit_:t.limitToLast=e.limit_),t}function Zs(e){const t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_),t.sin=!e.startAfterSet_),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_),t.ein=!e.endBeforeSet_),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==Us&&(t.i=e.index_.toString()),t}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class to{constructor(){this.rootNode_=Vs.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e.parent,e.name,e)}const Ma=/[\[\].#$\/\u0000-\u001F\u007F]/,Ua=/[\[\].#$\u0000-\u001F\u007F]/,Fa=10485760,qa=function(e){return"string"==typeof e&&0!==e.length&&!Ma.test(e)},za=function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),function(e){return"string"==typeof e&&0!==e.length&&!Ua.test(e)}(e)},ja=function(e,t,n){const i=n instanceof ts?new fs(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+ms(i));if("function"==typeof t)throw new Error(e+"contains a function "+ms(i)+" with contents = "+t.toString());if(gr(t))throw new Error(e+"contains "+t.toString()+" "+ms(i));if("string"==typeof t&&t.length>Fa/3&&F(t)>Fa)throw new Error(e+"contains a string greater than "+Fa+" utf8 bytes "+ms(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,r=!1;if(kr(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(r=!0,!qa(t)))throw new Error(e+" contains an invalid key ("+t+") "+ms(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=i).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=F(a),_s(o),ja(e,s,i),function(e){const t=e.parts_.pop();e.byteLength_-=F(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&r)throw new Error(e+' contains ".value" child '+ms(i)+" in addition to actual children.")}};
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * limitations under the License.
     */
class Wa{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Ha(e,t,n){!function(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||ds(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}(e,n),function(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Ba(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]);e.recursionDepth_--}(e,(e=>ps(e,t)||ps(t,e)))}function Ba(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();hr&&dr("event: "+n.toString()),Nr(i)}}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
function(e){!function(e){er=e}(Ze),Ge(new z("database",((e,{instanceIdentifier:t})=>fl(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),nt(Xi,Zi,e),nt(Xi,Zi,"esm2017")}();const ml=et({apiKey:"AIzaSyANIA0nk7P3RTo33P86jmW3GM6jMxxdoAs",authDomain:"moodlequizdatascraping.firebaseapp.com",databaseURL:"https://moodlequizdatascraping-default-rtdb.firebaseio.com",projectId:"moodlequizdatascraping",storageBucket:"moodlequizdatascraping.appspot.com",messagingSenderId:"782692660220",appId:"1:782692660220:web:8258d30da03e338f4c3879"}),gl=function(e=tt()){const t=Ye(e,"auth");if(t.isInitialized())return t.getImmediate();const n=
/**
     * @license
     * Copyright 2020 Google LLC
     *
